    ...
    <>
      ...
      <main className="mx-auto max-w-7xl space-y-6 px-4 py-9 sm:px-6 sm:py-12 lg:px-8">
        <div className="max-w-4xl space-y-3">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-amber-700">Services</p>
          <h1 className="max-w-5xl font-serif text-[2.35rem] font-semibold leading-tight tracking-tight text-slate-950 sm:text-5xl lg:max-w-4xl">Career support designed around the real questions international students ask during the UK job search.</h1>
              ...
              <div className="grid gap-0 lg:grid-cols-[minmax(240px,320px)_1fr]">
                ...
                <div className="grid gap-5 p-5 xl:grid-cols-[1.15fr_0.85fr]">
                  <div className="min-w-0">
                    <h2 className="font-serif text-[1.9rem] font-semibold leading-tight text-slate-950 sm:text-3xl">{service.title}</h2>
